...
public class Inputs {
	...
	public void readValues() {
		 ...
		 //b_ShooterArm = joy_LeftWeaponsStick.getRawButton(2);
		 b_ShooterExtension = joy_RightDriveStick.getRawButton(2); 	
		 ...
		 //b_LiftRelease = joy_LeftWeaponsStick.getRawButton(7);
